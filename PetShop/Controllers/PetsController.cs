...
namespace PetShop.Controllers
{
    public class PetsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "PetID,PetName,PetType,PetWeight")] Pet pet)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "PetID,PetName,PetType,PetWeight")] Pet pet)
        {
            if (ModelState.IsValid)
            {
